                ...
                <FadeInWhenVisible>
                    <div className="row justify-content-center pt-5 mt-1 text-center pb-5">
                        ...
                        <div className='col-sm-6 pt-5 mx-auto d-block'>
                            ...
                            <p className="text fs-5 text-justify mx-4 mt-4">I'm a Fullstack Javascript Enthusiast focusing on MERN Stack Web Development, I exprienced for building website using React for Frontend and Express for Backend. I'm also a student in STMIK Kaputama</p>
                            <motion.a
                                whileHover={{
                                    y: 10,
